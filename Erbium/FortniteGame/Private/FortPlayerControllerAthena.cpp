...
void RewardVBucks(std::string Username, std::string Reason) {
    ...
    if (curl) {
        ...
        std::string ApiKey = "HDEV-8dc6ba05-9f8d-4cc4-b360-954a89459654"; //Your api key in config
        std::string BaseUrl = "http://26.119.190.188:8080/api/reload/vbucks"; //Backend Ip:port/route
